---
description: "Use when a PR needs thorough review — dispatches 6 specialized agents (silent failures, type design, simplification, test gaps, comment analysis, general review) in parallel. Also use for \"review this PR\", \"review PR"
---
