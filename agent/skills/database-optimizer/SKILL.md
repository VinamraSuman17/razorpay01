...
license: "MIT"
metadata: {"author":"https://github.com/Jeffallan","version":"1.1.0","domain":"infrastructure","triggers":"database optimization, slow query, query performance, database tuning, index optimization, execution plan, EXPLAIN ANALYZE, database performance, PostgreSQL optimization, MySQL optimization","role":"specialist","scope":"optimization","output-format":"analysis-and-code","related-skills":"csharp-developer, devops-engineer, graphql-architect, java-architect, postgres-pro, rag-architect, rails-expert, spring-boot-engineer"}
---
# Database Optimizer
