...
license: "MIT"
metadata: {"author":"https://github.com/Jeffallan","version":"1.1.0","domain":"infrastructure","triggers":"Kubernetes, K8s, kubectl, Helm, container orchestration, pod deployment, RBAC, NetworkPolicy, Ingress, StatefulSet, Operator, CRD, CustomResourceDefinition, ArgoCD, Flux, GitOps, Istio, Linkerd, service mesh, multi-cluster, cost optimization, VPA, spot instances","role":"specialist","scope":"infrastructure","output-format":"manifests","related-skills":"chaos-engineer, cloud-architect, devops-engineer, microservices-architect, ml-pipeline, security-reviewer, sre-engineer, terraform-engineer"}
---
