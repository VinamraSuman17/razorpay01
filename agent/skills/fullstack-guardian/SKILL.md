...
license: "MIT"
metadata: {"author":"https://github.com/Jeffallan","version":"1.1.0","domain":"security","triggers":"fullstack, implement feature, build feature, create API, frontend and backend, full stack, new feature, implement, microservices, websocket, real-time, deployment pipeline, monorepo, architecture decision, technology selection, end-to-end","role":"expert","scope":"implementation","output-format":"code","related-skills":"architecture-designer, code-documenter, debugging-wizard, devops-engineer, django-expert, dotnet-core-expert, fastapi-expert, feature-forge, flutter-expert, java-architect, javascript-pro, laravel-specialist, nestjs-expert, php-pro, rails-expert, react-expert, secure-code-guardian, spec-miner, test-master, typescript-pro, vue-expert, wordpress-pro"}
---
# Fullstack Guardian
